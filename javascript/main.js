...
;(function($) {
   ...
   var isMobile = {
	...
	var newsList = function() {
         $('.flat-row').each(function() {               
            if ( $().owlCarousel ) {
                $(this).find('.newsList').owlCarousel({
                    loop: true,
                    margin: 30,
                    nav: true,
                    dots: false,                     
	...
	var newsListHidden = function() {
         $('.flat-row').each(function() {               
            if ( $().owlCarousel ) {
                $(this).find('.newsListHidden').owlCarousel({
					loop: true,
					 autoplay: true,   
					// nav: true,
					items:1,
	...
	var widgetNewsList = function() {
		
         $('.flat-row').each(function() {   		 
            if ( $().slick ) {
                $(this).find('.widget-newsList').slick({
				// autoplay: true,
                vertical: true,
                slidesToShow: 5,
                slidesToScroll: 1,
                ...
                autoplaySpeed: 10000,
                infinite: true,
				nextArrow: '<i class="slide-icon slide-icon-1  slide-next fa fa-arrow-down"></i>',
                prevArrow: '<i class="slide-icon slide-icon-1 slide-prev fa fa-arrow-up"></i>'
        ...
        $('#contactform').each(function() {
            $(this).validate({
                submitHandler: function( form ) {
                    var $form = $(form),
                        str = $form.serialize()+"&isAjax=true",
                        loading = $('<div />', { 'class': 'loading' });
				
				   $.ajax({
                        type: "POST",
                        //url:  $form.attr('action'),
						url:  window.location.origin+"/System/ModuleContact",
                        data: str,
                        beforeSend: function () {
